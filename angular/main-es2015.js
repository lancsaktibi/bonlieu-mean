...
const BACKEND_URL = src_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].apiUrl + '/user/';
...
let PostCreateComponent = class PostCreateComponent {
    ...
    onImagePicked(event) {
        ...
        reader.onload = () => {
            this.imagePreview = reader.result; // after image loaded, store url
        };
